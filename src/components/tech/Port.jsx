...
import ImageVehicle from '/assets/technology/image-spaceport-portrait.jpg'
import ImageVehicletwo from '/assets/technology/image-spaceport-landscape.jpg'
  ...
  return (
    ...
    <MainContainer>
          <NavComponents>
              ...
              <Link to='/port'><span className="circle-bg">3</span></Link>
          </NavComponents>

        <Content>
            <AllText>
                <SubText>The Terminology ...</SubText>
                <MainTitle>Spaceport</MainTitle>
                <Description>
